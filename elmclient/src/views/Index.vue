    ...
    return {
      businessList: [
        ...
        },
        {
          ...
          businessImg: require('../assets/sj05.png'),
          // ... 其他商家信息
        }
      ]
    }
